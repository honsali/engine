...
public class BeSpecificationPrinter extends Printer {
    ...
    public void print(Entity entity) {
        ...
        f.L("");
        f.L____("public static Specification<", entity.uname, "> buildSpecification(", entity.uname, "Filtre filtre) {");
        f.L________("return (root, query, builder) -> {");
        f.L____________("if (filtre == null) {");
        f.L________________("return builder.conjunction();");
        f.L____________("}");
        f.L("");
        ...
        f.L("");
        f.L____________("return builder.and(predicates.toArray(Predicate[]::new));");
        f.L________("};");
        f.L____("}");
        f.L("");
