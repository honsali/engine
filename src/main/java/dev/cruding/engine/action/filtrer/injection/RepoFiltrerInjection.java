...
public class RepoFiltrerInjection extends RepoActionInjection {
    ...
    public void addRepositoryDeclaration(JavaFlow f) {
        ...
        f.L____________("Page<", entite().uname, "> filtrer(@Param(\"query\") ", entite().uname, " ", entite().lname, ", Pageable pageable);");
    }
}
