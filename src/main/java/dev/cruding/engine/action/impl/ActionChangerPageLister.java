...
public class ActionChangerPageLister extends ActionAvecTable {

    public ActionChangerPageLister() {
        super("changerPage");
    }
    ...
    public void addCtrlImplementation(MCFlow f) {
        ...
        f.L____("resultat.listePaginee", entity.uname, " = await Service", entity.uname, ".listerEnPage(requete.pageCourante);");
        f.L("};");
    }
