...
public class ServiceFilterInjection extends ActionServiceInjection {
    ...
    public void addServiceImplementation(Flow f) {
        ...
        f.L____("const { data } = await axios.post<PageResponse<I", entity().uname, ">>(`${API_URL}", entity().path, "/", lnameWithoutEntity(), "`, ", entity().lname).__(", { params: { page: pageable.page, size: pageable.size } });");
        f.L____("return {");
