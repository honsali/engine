...
public class ElementEntantQueComposant extends Composant {

    public Element subElement;
    public Element parentElement;

    public ElementEntantQueComposant(Element parentElement, Element subElement) {
        super(parentElement);
    ...
    public ElementEntantQueComposant byForm() {
        this.subElement.byForm = true;
        return this;
    }

    public ElementEntantQueComposant byProp(String byProp) {
