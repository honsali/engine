...
import dev.cruding.engine.element.impl.ElementActionCreer;
...
public class BoutonCreer extends Bouton {
    ...
    public BoutonCreer(Page page, Entity entity) {
        this(page, entity, "creer");
    }

    public BoutonCreer(Page page, Entity entity, String ltype) {
        super(page, entity, ltype);
        this.element = new ElementActionCreer(entity, this);
        this.action = new ActionSpecifique(this.ltype);
        this.action.lrest("post").confirmer().byForm().resultatInId();
