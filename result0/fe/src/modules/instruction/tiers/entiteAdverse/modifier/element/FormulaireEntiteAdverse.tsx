...
import { Bloc, CadreHaut, ChampCache, ChampDate, ChampEmail, ChampOuiNon, ChampReference, ChampReferenceAvecFiltre, ChampTel, ChampTexte, ChampTexteLong, Formulaire } from 'waxant';
