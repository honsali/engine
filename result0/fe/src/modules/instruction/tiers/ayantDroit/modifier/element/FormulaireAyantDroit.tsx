...
import { Bloc, ChampCache, ChampDate, ChampOuiNon, ChampReference, ChampTexte, ChampTexteArabe, ChampVide, Formulaire, useOnChange } from 'waxant';
    ...
    return (
        <Bloc>
            <Formulaire form={form} nombreColonne={2}>
                ...
                <ChampCache nom="id" />
                <ChampCache nom="situationFamiliale" />
                <ChampCache nom="adresse" />
                <ChampCache nom="tel" />
                <ChampCache nom="email" />
            </Formulaire>
        </Bloc>
    );
};
